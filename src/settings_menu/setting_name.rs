...
impl SettingName for ScoreDisplay {
    fn name(&self) -> String {
        match self {
            ScoreDisplay::Decimal => t!("tetris.settings.score_display.decimal"),
            ScoreDisplay::Classic => t!("tetris.settings.score_display.classic"),
            ScoreDisplay::Base36 => t!("tetris.settings.score_display.base36"),
        }
        .into()
    }
}

impl SettingName for LevelDisplay {
    fn name(&self) -> String {
        match self {
            LevelDisplay::Decimal => t!("tetris.settings.level_display.decimal"),
            LevelDisplay::Classic => t!("tetris.settings.level_display.classic"),
        }
        .into()
    }
}
